...
fn discover_marketplace_paths_from_roots(
    ...
    for root in additional_roots {
        if let Some(repo_root) = get_git_repo_root(root) {
  ...
  "plugins": [
    ...
    },
    {
      ...
      "source": {
        ...
        let marketplaces =
            list_marketplaces_with_home(std::slice::from_ref(&repo_root), Some(&home_root))
                .unwrap();
  ...
  "plugins": [
    {
      ...
      "source": {
        ...
        let resolved = resolve_marketplace_plugin(&repo_marketplace, "local-plugin").unwrap();
  ...
  "plugins": [
    {
      ...
      "source": {
        ...
        let marketplaces =
            list_marketplaces_with_home(&[repo_root.clone(), nested_root], None).unwrap();
